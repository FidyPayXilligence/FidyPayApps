...
public class ENachTransactionPdfExporter {
	...
	public PdfWriter generateDynamicpdf(HttpServletResponse response, List<ENachTransactionResponse> list2,
	...
	public PdfPTable generateFirstPage(List<ENachTransactionResponse> activityList) {
		...
		try {
			...
			for (ENachTransactionResponse transactionsReportPayLoad : activityList) {
				...
				insertValueIntoRow(table, "" + transactionsReportPayLoad.getCustomerId(), Element.ALIGN_LEFT, 1,
						otherfont, null);
				insertValueIntoRow(table, "" + transactionsReportPayLoad.getCustomerName(), Element.ALIGN_LEFT, 1,
						otherfont, null);
				...
				insertValueIntoRow(table, "" + transactionsReportPayLoad.getTrxnRefId(), Element.ALIGN_LEFT, 1,
						otherfont, null);
				insertValueIntoRow(table, "" + transactionsReportPayLoad.getUmrnNo(), Element.ALIGN_LEFT, 1, otherfont,
						null);
				insertValueIntoRow(table, "" + transactionsReportPayLoad.getMandateId(), Element.ALIGN_LEFT, 1,
						otherfont, null);
