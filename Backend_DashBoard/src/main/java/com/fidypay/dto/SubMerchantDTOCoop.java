...
public class SubMerchantDTOCoop {
	...
	public SubMerchantDTOCoop() {
	}

	public SubMerchantDTOCoop(String action, String merchantBussiessName, String merchantVirtualAddress, String panNo,
			String contactEmail, String gstn, String perDayTxnCount, String merchantBussinessType, String perDayTxnLmt,
			String perDayTxnAmt, String mobile, String address, String state, String city, String pinCode,
			String subMerchantId, String mCC, String subMerchantBankName, String subMerchantBankAccount,
			String subMerchantIfscCode, String merchantGenre, String name, String subMerchantBankBranch) {
		this.action = action;
	...
	public String getIsMessageActive() {
		return isMessageActive;
	}

	public void setIsMessageActive(String isMessageActive) {
		this.isMessageActive = isMessageActive;
	}
