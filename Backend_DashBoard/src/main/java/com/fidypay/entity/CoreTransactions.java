...
@Table(name = "CORE_TRANSACTIONS", indexes = {
		...
		@Index(name = "index_PAYMENT_CHANNEL_ID", columnList = "PAYMENT_CHANNEL_ID"),
		@Index(name = "index_TRXN_SOURCE_ID", columnList = "TRXN_SOURCE_ID"),
		@Index(name = "index_SERVICE_ID", columnList = "SERVICE_ID"),
		@Index(name = "index_TRXN_REF_ID", columnList = "TRXN_REF_ID"),
		@Index(name = "index_TRXN_SERVICE_IDENTIFIER", columnList = "TRXN_SERVICE_IDENTIFIER"),
		@Index(name = "index_TRXN_SERVICE_DETAILS", columnList = "TRXN_SERVICE_DETAILS"),
		@Index(name = "index_TRXN_PAYMENT_IDENTIFIER", columnList = "TRXN_PAYMENT_IDENTIFIER"),
		@Index(name = "index_TRXN_PAYMEN_DETAILS", columnList = "TRXN_PAYMEN_DETAILS"),
		@Index(name = "index_TRXN_DATE", columnList = "TRXN_DATE"),
		@Index(name = "index_TRXN_AMOUNT", columnList = "TRXN_AMOUNT"),
		@Index(name = "index_SERVICE_CHARGE", columnList = "SERVICE_CHARGE")
          })
...
//	@Id
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="RANS_SEQ")
//	@SequenceGenerator(name = "RANS_SEQ", sequenceName = "RANS_SEQ", initialValue = 1, allocationSize=1)
//	@Column(name="TRANSACTION_ID")
//	private long transactionId;
