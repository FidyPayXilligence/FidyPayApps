...
@Table(name = "RK_MERCHANT_INFO", indexes = {
		@Index(name = "index_RK_MERCHANT_INFO_ID", columnList = "RK_MERCHANT_INFO_ID"),
		@Index(name = "index_MERCHANT_ID", columnList = "MERCHANT_ID"),
		@Index(name = "index_MERCHANT_CALLBACK_URL", columnList = "MERCHANT_CALLBACK_URL"),
		@Index(name = "index_MERCHANT_CODE", columnList = "MERCHANT_CODE")
		})
