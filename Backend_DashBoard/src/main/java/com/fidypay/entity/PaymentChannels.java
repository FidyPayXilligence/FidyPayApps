...
@Table(name = "PAYMENT_CHANNELS", indexes = {
		...
		@Index(name = "index_PC_NAME", columnList = "PC_NAME"),
		@Index(name = "index_PC_DETAILS", columnList = "PC_DETAILS"),
		@Index(name = "index_PC_SETTLEMENT_FREQUENCY", columnList = "PC_SETTLEMENT_FREQUENCY"),
		@Index(name = "index_PC_BANK_NAME", columnList = "PC_BANK_NAME"),
		@Index(name = "index_PC_BANK_BRANCH", columnList = "PC_BANK_BRANCH"),
		@Index(name = "index_PC_BANK_CODE", columnList = "PC_BANK_CODE"),
		@Index(name = "index_PC_ACCOUNT_NO", columnList = "PC_ACCOUNT_NO"),
		@Index(name = "index_PC_EMAIL", columnList = "PC_EMAIL"),
		@Index(name = "index_PC_PHONE", columnList = "PC_PHONE"),
		@Index(name = "index_IS_WALLET", columnList = "IS_WALLET")
		})
