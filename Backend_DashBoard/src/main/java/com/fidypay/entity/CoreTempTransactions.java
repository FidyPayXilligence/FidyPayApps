...
@Table(name = "CORE_TEMP_TRXN", indexes = {
		@Index(name = "index_CORE_TEMP_TRXN_ID", columnList = "CORE_TEMP_TRXN_ID"),
		@Index(name = "index_TRANSACTION_ID", columnList = "TRANSACTION_ID"),
		@Index(name = "index_TRXN_INFO", columnList = "TRXN_INFO"),
		@Index(name = "index_APP_TRXN_INFO", columnList = "APP_TRXN_INFO"),
		@Index(name = "index_RETRY_COUNT", columnList = "RETRY_COUNT")
          })
