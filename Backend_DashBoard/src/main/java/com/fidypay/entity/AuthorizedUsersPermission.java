...
@Table(name = "AUTHORIZED_USERS_PERMISSION", indexes = {
		@Index(name = "index_AUTHORIZED_USERS_PERMISSION_ID", columnList = "AUTHORIZED_USERS_PERMISSION_ID"),
		@Index(name = "index_AUTHORIZED_USERS", columnList = "AUTHORIZED_USERS"),
		@Index(name = "index_AUTH_USERS_MANAGE_PERMISSION", columnList = "AUTH_USERS_MANAGE_PERMISSION"),
		@Index(name = "index_CUSOMERS_MANAGE_PERMISSION", columnList = "CUSOMERS_MANAGE_PERMISSION"),
		@Index(name = "index_UP_MERC_MANAGE_PERMISSION", columnList = "UP_MERC_MANAGE_PERMISSION"),
		@Index(name = "index_TP_MERC_MANAGE_PERMISSION", columnList = "TP_MERC_MANAGE_PERMISSION"),
		@Index(name = "index_SERVICE_MANAGE_PERMISSION", columnList = "SERVICE_MANAGE_PERMISSION"),
		@Index(name = "index_PROVIDER_MANAGE_PERMISSION", columnList = "PROVIDER_MANAGE_PERMISSION"),
		@Index(name = "index_PAYCHANNEL_MANAGE_PERMISSION", columnList = "PAYCHANNEL_MANAGE_PERMISSION"),
		@Index(name = "index_API_MANAGE_PERMISSION", columnList = "API_MANAGE_PERMISSION"),
		@Index(name = "index_POS_MANAGE_PERMISSION", columnList = "POS_MANAGE_PERMISSION"),
		@Index(name = "index_TILL_FLOAT_MANAGE_PERMISSION", columnList = "TILL_FLOAT_MANAGE_PERMISSION"),
		@Index(name = "index_MERSERV_MANAGE_PERMISSION", columnList = "MERSERV_MANAGE_PERMISSION"),
		@Index(name = "index_DSR_MANAGE_PERMISSION", columnList = "DSR_MANAGE_PERMISSION"),	
		@Index(name = "index_SETTLEMENT_MANAGE_PERMISSION", columnList = "SETTLEMENT_MANAGE_PERMISSION"),
		@Index(name = "index_RECON_MANAGE_PERMISSION", columnList = "RECON_MANAGE_PERMISSION")        
          })
