...
public class MerchantSubMerchantInfoAllPayload {
	...
	public char getSoundBoxExist() {
		return soundBoxExist;
	}

	public void setSoundBoxExist(char soundBoxExist) {
		this.soundBoxExist = soundBoxExist;
	}
