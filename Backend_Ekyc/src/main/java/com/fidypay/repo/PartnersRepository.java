...
public interface PartnersRepository extends JpaRepository<Partners, Long> {
	...
	Optional<Partners> findByPartnerMobile(String encString);
	Optional<Partners> findByPartnerEmail(String encString);

	Optional<Partners> findByPartnerMobileAndPartnerEmail(String encString, String encString2);
