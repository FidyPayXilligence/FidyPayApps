...
import com.fidypay.ServiceProvider.Decentro.VideoLivenessService;
...
public class VideoLivenessCotroller {

	private static final Logger LOGGER = LoggerFactory.getLogger(VideoLivenessCotroller.class);
	...
	@Autowired
	private VideoLivenessService videoLivenessService;

	@ApiOperation(value = "Video Liveness")
	@PostMapping("/videoLiveness")
		...
		try {
			...
			if (merchantInfo.getIsMerchantActive() == '1'
				...
				if (findById.isPresent()) {
					...
					return videoLivenessService.saveDataForVideoLiveness(video, merchantInfo.getMerchantId(),
