...
public class FaceMatcherAndImageLivenessController {

	private static final Logger LOGGER = LoggerFactory.getLogger(FaceMatcherAndImageLivenessController.class);
	...
	@ApiOperation(value = "Image Passive Liveness")
	@PostMapping("/imagePassiveLiveness")
	public Map<String, Object> imagePassiveLiveness(@RequestHeader("Authorization") String Authorization,
		...
		try {
			...
			if (merchantInfo.getIsMerchantActive() == '1'
				...
				if (findById.isPresent()) {
					...
					return facematcherandimagelivenessservice.saveDataForImageLiveness(image,
...
//							ResponseMessage.SERVICE_CLOSED);
	...
	public Map<String, Object> faceMatching(@RequestHeader("Authorization") String Authorization,
			@RequestHeader(value = "Client-Id") String clientId, @RequestHeader("Client-Secret") String clientSecret,
			@RequestPart(value = "image1") @NotNull MultipartFile image1,
			@RequestPart(value = "image2") @NotNull MultipartFile image2) throws Exception {
		Map<String, Object> map = new HashMap<>();
		try {
...
//					return facematcherandimagelivenessservice.faceMatcherSignzy(image1, image2,
...
//		Map<String, Object> map = new HashMap<>();
//
//		map = ekycCommonLogicConfig.authenticateUser(Authorization, clientId, clientSecret);
//
...
//
//			return facematcherandimagelivenessservice.saveDataForApi(merchantId, merchantFloatAmount, businessName,
//					merchantEmail);
//
//		}
//
