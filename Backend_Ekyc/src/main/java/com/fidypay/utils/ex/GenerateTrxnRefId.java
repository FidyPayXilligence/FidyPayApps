...
public class GenerateTrxnRefId {
	...
	public static String generateMerchantTrxnRefId() {

		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddhhmmssms");
		Timestamp timestamp = new Timestamp(System.currentTimeMillis());
		String timestampDate = sdf.format(timestamp);
		String merchantTrxnRefId = timestampDate;
		System.out.println("merchantTrxnRefId : " + merchantTrxnRefId + " length " + merchantTrxnRefId.length());
	...
	public static void main(String[] args) {
		String generateTranRefID = generateTranRefID("Hello");
		System.out.println(generateTranRefID);
