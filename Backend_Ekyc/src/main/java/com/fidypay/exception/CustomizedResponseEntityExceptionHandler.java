...
import com.fidypay.wrapper.BaseResponse;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMissingServletRequestParameter(
		...
		BaseResponse baseResponse = new BaseResponse(HttpStatus.BAD_REQUEST,
				ResponseMessage.MISSING_PARAMETER_DESCRIPTION, ResponseMessage.BAD_REQUEST);
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		apiError.setDescription(ResponseMessage.MISSING_PARAMETER_DESCRIPTION);
		apiError.setStatus(HttpStatus.BAD_REQUEST);
		// apiError.setTimestamp(DateAndTime.getCurrentDateTime());
