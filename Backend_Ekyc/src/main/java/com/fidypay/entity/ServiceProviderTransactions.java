...
public class ServiceProviderTransactions implements java.io.Serializable {
	...
	public ServiceProviderTransactions(long spTransactionId, CoreTransactions coreTransactions,
			ServiceProviders serviceProviders, String spReferenceId, String operatorRefNo, String responseMessage,
			Double commissionAmount, Double spAmount, String userIdnumber) {
		this.spTransactionId = spTransactionId;
